...
@interface QFResumeManager ()<NSURLSessionDelegate, NSURLSessionTaskDelegate>
...
@implementation QFResumeManager
...
+(QFResumeManager*)resumeManagerWithURL:(NSURL*)url
    ...
    QFResumeManager *manager = [[QFResumeManager alloc]init];
